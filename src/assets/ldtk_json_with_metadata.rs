...
impl LdtkJsonWithMetadata<InternalLevels> {
    ...
    ///
    /// [loaded]: crate::assets::LdtkProject#raw-vs-loaded-levels
    pub fn get_loaded_level_at_indices(&self, indices: &LevelIndices) -> Option<LoadedLevel<'_>> {
    ...
    ///
    /// [loaded]: crate::assets::LdtkProject#raw-vs-loaded-levels
    pub fn get_loaded_level_by_iid(&self, iid: &String) -> Option<LoadedLevel<'_>> {
